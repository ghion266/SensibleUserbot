...
ALIVE_caption = "`GTS Userbot IS:` **ONLINE**\n\n"
...
ALIVE_caption += "**GTS  OS** : `3.14`\n\n"
ALIVE_caption += "**Current Sat** : `GTS Userbot Sat-2.95`\n\n"
ALIVE_caption += f"**GTS** : {DEFAULTUSER} \n\n"
ALIVE_caption += "**Heroku Database** : `AWS - Working Properly`\n\n"
ALIVE_caption += "**Bot Made By @Gts12 \n\n"
#@commandoutgoing=True, pattern="^.alive$")
